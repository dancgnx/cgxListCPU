...
def go():
    ...
    custom_group = parser.add_argument_group('custom_args', 'Metrics')
    custom_group.add_argument("--min", help="minimum CPU level to alert",required=True,
                              default=None, action="store",dest="min",type=int)
    custom_group.add_argument("--hours", help="amount of hours to look back",required=True,
                              default=None, action="store",dest="hours",type=int)
